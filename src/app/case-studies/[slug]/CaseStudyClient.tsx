...
export const CONTENT: Record<string, { tag: string; title: string; accent: "blue"|"purple"; overview: string; challenge: string; solution: string; result: string; keyPoints: string[] }> = {
