...
export const TIMELINE = [
  ...
  { company:"RedBus",        role:"Product & Payments",                                       period:"—",           summary:"Built payment infrastructure from scratch across Vietnam, Cambodia and Indonesia. Integrated PhonePe, Razorpay, Mobikwik and JusPay. Developed expertise in distributed systems and cross-functional execution." },
  ...
  { company:"Sentients",     role:"Founder",                                                  period:"Now",         summary:"A systems studio at the intersection of Product, AI Automation and Cognitive Computing." },
] as const;

export const SYSTEMS = [
  { id:"payments-infrastructure", title:"Payments Infrastructure",       subtitle:"Multi-geography payment systems",  description:"Built payment systems from zero across Vietnam, Cambodia and Indonesia. Integrated multiple providers, designed dashboards and operational tooling.", tags:["Distributed Systems","Payments","Product"],           href:"/systems/payments-infrastructure" },
  { id:"enterprise-scm",          title:"Enterprise SCM Systems",        subtitle:"Carl Zeiss supply chain platform", description:"End-to-end ownership of Order Management, Finance, Post Sales and Lens Calculation Engine on Azure-native architecture.",                      tags:["Enterprise","Azure","Product Ownership"],             href:"/systems/enterprise-scm" },
  { id:"autonomous-qa",           title:"Autonomous QA Intelligence",    subtitle:"Self-improving QA platform",       description:"Designed an intelligent system that monitors repositories, detects regressions, performs bug analysis and generates actionable engineering outputs.", tags:["Agentic AI","Automation","QA"],                       href:"/systems/autonomous-qa" },
  { id:"numocore",                title:"Numocore",                      subtitle:"Cognitive reasoning platform",     description:"Research and platform development around advanced cognitive systems and intelligent reasoning frameworks.",                                    tags:["Cognitive AI","Research","Reasoning"],                href:"/systems/numocore" },
  { id:"myitihas",                title:"MyItihas",                      subtitle:"Knowledge and cognition platform", description:"Structured intelligence system focused on deep contextual understanding and knowledge representation.",                                       tags:["Knowledge Systems","Cognitive AI","Research"],        href:"/systems/myitihas" },
] as const;
